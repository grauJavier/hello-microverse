...
The **Hello Microverse!** project is an exercise for mastering tools and best practices of version control and GitHub flow.
...
- **Linters**
- **README.md file based on Microverse template**
...
- Any Web Browser that suports HTML & CSS such as [Brave](https://brave.com/).
...
`git clone https://github.com/grauJavier/hello-microverse.git`
...
Open `index.html` file with your Code Editor if you want to add new desire text.
...
I would like to thank to my proficient code reviewer.
